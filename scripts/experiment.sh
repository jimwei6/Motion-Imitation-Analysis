...
bash './MoConVQ/Script/tracking_directory.sh' './amass_ds/KIT_resampled/' 'KIT' './experiments'
...
bash './MoConVQ/Script/tracking_directory.sh' './amass_ds/TotalCapture_resampled/' 'TotalCapture' './experiments'
